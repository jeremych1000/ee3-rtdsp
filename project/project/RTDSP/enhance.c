...
if(ratio<	0.316227766	) return				4.75	;
else if (ratio <	0.398107171	) return				-0.6	;
else if (ratio <	0.501187234	) return				-0.45	;
else if (ratio <	0.630957344	) return				-0.3	;
else if (ratio <	0.794328235	) return				-0.15	;
else if (ratio <	1	) return				0	;
else if (ratio <	1.258925412	) return				0.15	;
else if (ratio <	1.584893192	) return				0.3	;
else if (ratio <	1.995262315	) return				0.45	;
else if (ratio <	2.511886432	) return				0.6	;
else if (ratio <	3.16227766	) return				0.75	;
else if (ratio <	3.981071706	) return				0.9	;
else if (ratio <	5.011872336	) return				1.05	;
else if (ratio <	6.309573445	) return				1.2	;
else if (ratio <	7.943282347	) return				1.35	;
else if (ratio <	10	) return				1.5	;
else if (ratio <	12.58925412	) return				1.65	;
else if (ratio <	15.84893192	) return				1.8	;
else if (ratio <	19.95262315	) return				1.95	;
else if (ratio <	25.11886432	) return				2.1	;
else if (ratio <	31.6227766	) return				2.25	;
else if (ratio <	39.81071706	) return				2.4	;
else if (ratio <	50.11872336	) return				2.55	;
else if (ratio <	63.09573445	) return				2.7	;
else if (ratio <	79.43282347	) return				2.85	;
else		return				1	;
